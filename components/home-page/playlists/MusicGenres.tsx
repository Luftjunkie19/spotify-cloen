...
function MusicGenres({closedRight}: Props) {
  ...
  return (
    <>
      ...
      <div className={`grid snap-always snap-mandatory gap-4 sm:auto-cols-[45%] md:auto-cols-[25%] lg:auto-cols-[24%] sm:overflow-x-auto snap-inline sm:grid-flow-col xl:snap-none ${closedRight ? 'xl:grid-cols-4 2xl:grid-cols-5' : 'xl:grid-cols-5 2xl:grid-cols-7 3xl:grid-cols-9'} px-4`}>
