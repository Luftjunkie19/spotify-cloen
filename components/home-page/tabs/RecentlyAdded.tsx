...
function RecentlyAdded({ closedRight }: Props) {
  ...
  return (
    <>
      ...
      <div className={`grid snap-always snap-mandatory gap-4 sm:auto-cols-[50%] md:auto-cols-[35%] ${closedRight ? 'lg:auto-cols-[40%]' : 'lg:auto-cols-[25%]'} sm:overflow-x-auto snap-inline sm:grid-flow-col xl:snap-none ${closedRight ? 'xl:grid-cols-4 2xl:grid-cols-7' : 'xl:grid-cols-6 2xl:grid-cols-6 3xl:grid-cols-8'} px-4`}>
