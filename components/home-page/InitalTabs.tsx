...
function InitalTabs({}: Props) {
  return (
      <div className='grid sm:grid-cols-2 2xl:grid-cols-4 gap-2 p-4'>
          <div className="flex max-w-xs duration-500 transition-all hover:scale-[1.02] hover:-translate-y-1 hover:bg-spotifyMediumGray gap-6 rounded-lg bg-spotifyDarkGray cursor-pointer">
