  ...
  return (
      ...
      <div className="flex gap-6 items-center ">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="font-medium cursor-pointer hover:underline transition px-1">Es Tut Mir Leid</p>
      ...
      <div className="sm:flex lg:hidden gap-6">
        <button className='sm:block lg:hidden'><FaCheckCircle className="text-spotifyGreen" size={24}/></button>
           <button className='sm:block lg:hidden'><IoPlayCircle size={36} /></button>
      </div>
      ...
      <div className="sm:hidden lg:flex flex-col gap-2 self-center">
        <div className="flex gap-8 self-center">
          ...
          <button><IoPlayCircle size={36} /></button>
...
<input className="range range-xs max-w-24 [--range-shdw:#fff]"  type="range" name="" id="" />
